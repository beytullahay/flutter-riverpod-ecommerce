  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(offset: const Offset(0, 6), color: Colors.black.withOpacity(0.1), blurRadius: 8, spreadRadius: 2),
        ],
      ),
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    '${product[productIndex].price} TL',
                    style: AppTheme.kCardTitle,
                  ),
                  IconButton(
                    onPressed: () {
                      ref.read(proudctNotifierProvider.notifier).isSelectItem(product[productIndex].pid, productIndex);
                      ...
                      if (product[productIndex].isSelected == false) {
                        ...
                        ref.read(itemBagProvider.notifier).removeItem(product[productIndex].pid);
                      }
                    },
                    icon: product[productIndex].isSelected
                        ? const Icon(
